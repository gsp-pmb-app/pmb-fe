...
export const KartuUjian = () => {
  ...
  return (
    <div className="w-full">
      <div className="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow flex flex-col gap-2">
        <div ref={targetRef} className="mx-auto p-6 pb-0 w-155">
          <div className="border-2 border-black p-6 flex flex-col gap-4">
            <div className="text-black capitalize flex flex-col gap-0 justify-center items-center border-b-2 border-black pb-3">
              <h2 className="text-md font-semibold">
                KARTU TANDA PESERTA UJIAN MASUK
                <br />
                UNIVERSITAS GEMILANG SAPTA PERDANA
              </h2>
              <h5>PENERIMAAN MAHASISWA BARU PROGRAM PASCASARJANA (S2 & S3)</h5>
            </div>
            ...
            <div className="flex flex-row justify-between mt-3">
              <div className="grid grid-cols-[160px_10px_1fr] gap-y-1">
                ...
                <p>
                  ...
                  / {data?.jadwal?.sesi === "pagi" ? "9:00 WIB" : "13:00 WIB"}
                </p>
              </div>
        ...
        <div className="flex flex-row gap-4 justify-center items-center">
          <Button
            className="w-43 rounded-md bg-indigo-600 px-4 py-2 text-white font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 flex justify-center items-center gap-1"
            onClick={handleGeneratePdf}
          >
            <ArrowDownTrayIcon height={16} width={16} /> Download Kartu
          </Button>
          <Button
            className="w-43 rounded-md bg-indigo-600 px-4 py-2 text-white font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 flex justify-center items-center gap-1"
            onClick={handlePrint}
