      ...
      <div className="mt-2">
        ...
        >
          ...
          <input
            ...
            required={required}
            disabled={disabled}
            className="block min-w-0 grow bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none disabled:bg-gray-100 sm:text-sm/6"
          />
        </div>
      </div>
    </div>
